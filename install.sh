...
grep ads122c04.ko /lib/modules/$KVER/modules.dep && rm -fr $MODDESTDIR/ads122c04.ko || echo "No system ads122c04.ko file found. Install the new ads122c04.ko driver into the system"
install -p -m 644 ads122c04.ko $MODDESTDIR
